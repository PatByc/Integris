    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="flex flex-col items-center px-10 pb-28 pt-10 text-center">
        ...
        <h1 className="max-w-2xl text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
          Turn PDF invoices into<br />KSeF-ready XML — automatically
        </h1>

        <p className="mt-5 max-w-lg text-lg leading-relaxed text-gray-500">
          Connect your existing invoice workflow to KSeF without replacing your ERP.
          OCR extraction, human review, and one-click submission.
        </p>
      ...
      <section className="bg-gray-50 px-6 py-20">
        <div className="mx-auto grid max-w-4xl grid-cols-1 gap-10 sm:grid-cols-3">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mb-2 text-base font-semibold text-gray-900">OCR + AI Extraction</h3>
            <p className="text-sm leading-relaxed text-gray-500">
              Upload any PDF invoice. Google Vision OCR reads the text, AI normalises it into structured invoice fields — seller, buyer, line items, totals.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mb-2 text-base font-semibold text-gray-900">Human Review</h3>
            <p className="text-sm leading-relaxed text-gray-500">
              Every invoice goes through a side-by-side review screen. Correct any extraction errors before the data leaves your hands — AI assists, humans approve.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mb-2 text-base font-semibold text-gray-900">KSeF Submission</h3>
            <p className="text-sm leading-relaxed text-gray-500">
              Approved invoices are converted to FA(3) XML deterministically and submitted directly to KSeF. Full audit trail and UPO confirmation included.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-gray-100 py-8 text-center text-sm text-gray-400">
        © 2025 Integris · KSeF invoice middleware
      </footer>
    </div>
  );
}
